...
class TestOptions_semantic_segmentation():
    def __init__(self):
        pass
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_mode', choices={"instance_segmentation", "pose_estimation","semantic_segmentation"}, default='semantic_segmentation')
        ...
        self.parser.add_argument('--arch', type=str, default="PointNet_Segmentation")
        self.parser.add_argument('--resolution', type=int, default=2048)
