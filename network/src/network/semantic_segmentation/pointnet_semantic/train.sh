...
--dataset_path /home/ericlab/Downloads/sensor_b_box_2000_noize_max.hdf5 \
--checkpoints /home/ericlab/tsuchida/2023_01/checkpoints/Semseg/HV8/sensor_b_box_2000_max_noize \
--batch_size 1 \
--num_epoch 200 \
--save_epoch_freq 20 \
--lr 0.0001 \
